...
System.out.println(queryValues);
		String updateQuery = "Update participants set NAME = '"+ queryValues.get("NAME") +"' , GEN = '"+ queryValues.get("GEN") +"'  ,CLG = '"+ queryValues.get("CLG") +"', MOB = '"+ queryValues.get("MOB") +"' ,EMAIL = '"+ queryValues.get("EMAIL") +"' , ACCOM = '"+ queryValues.get("ACCOM") +"', EVENTNO = '"+ queryValues.get("EVENTNO") +"', ORGANIZER = '"+ queryValues.get("ORGANIZER") +"' , GROUPNAME = '"+ queryValues.get("GROUPNAME") +"', udpateStatus = '"+"no"+"'    where KSID = '"+ queryValues.get("KSID") +"'";
